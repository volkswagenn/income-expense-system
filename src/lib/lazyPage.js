 ...
 *
 * คู่กันนี้ vercel.json ตั้งกฎ rewrite ให้ข้าม /assets/ ไว้ด้วย (JSON ใส่คอมเมนต์ไม่ได้
 * จึงอธิบายไว้ที่นี่) ของเดิมกฎ catch-all ครอบทุกเส้นทาง ทำให้ไฟล์ที่หายไปถูกตอบกลับเป็น
 * index.html พร้อมสถานะ 200 แทนที่จะเป็น 404 ซึ่งทำให้ข้อความ error ชี้ต้นเหตุไม่ตรง
 *
