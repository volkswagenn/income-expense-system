...
-- ผลตรวจต้องได้ ตาราง 6/6 · คอลัมน์ 13/13 · ฟังก์ชัน 16/16 และส่วนที่ 14 เป็น 0 ทั้งสองแถว
-- ============================================================================
...
union all
select 'คอลัมน์ที่เติมเพิ่ม', count(*)::text || ' / 13'
...
union all
select 'ฟังก์ชัน RPC ของบัตร', count(*)::text || ' / 16'
